...
namespace UserRegistration.API.Models
{
    public class UserCreationDto
    {
        ...
        [MinLength(8, ErrorMessage = "A Naturalidade deve conter pelo menos 8 caracteres.")]
        ...
        [Required]
        [AllowedValues([1,2], ErrorMessage = "O valores aceitos são 1 para usuário admin, 2 para usuário comum")]
